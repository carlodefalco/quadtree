function fpl_vtk_write_field_quadmesh_rt (basename, msh, sidedata, endfile)
    ...
    for iel = refineable_elements
        ...
        # Evaluate Raviart-Thomas basis functions at the current element vertices.
        [dphi_x, dphi_y] = bim2c_quadtree_eval_dfun_rt(msh, iel, nodes(1, :), nodes(2, :));
