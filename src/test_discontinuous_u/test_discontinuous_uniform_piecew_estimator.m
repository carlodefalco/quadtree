...
for i = 1 : 10
    ...
    err_rec_u_1(i) = norm(bim2c_quadtree_pde_error_L2_node_q2(msh1, u(omega1), u_ex(omega1)), 2);
    err_rec_u_2(i) = norm(bim2c_quadtree_pde_error_L2_node_q2(msh2, u(omega2), u_ex(omega2)), 2);
    ...
    crit = 1;
    to_refine = bim2c_quadtree_pde_ZZ_to_refine(msh, estimator, 1e-4 / sqrt(Nnodes), crit);
